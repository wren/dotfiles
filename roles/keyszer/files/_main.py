...
keymap("Mac Numpad - Numlock is Clear",{
    C("Numlock"):               C("Esc"),                       # Turn Numlock key into "Clear" key for calculator apps
}, lambda ctx: ctx.wm_class.casefold() not in remotes and MAC_NUMPAD_ON)
